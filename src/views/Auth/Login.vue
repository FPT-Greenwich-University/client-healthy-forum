      ...
      <v-row align="center" class="mt-16" no-gutters style="height: 150px">
        ...
        <v-col class="col-12 col-xl-5 col-lg-5 col-md-8 col-sm-10">
          <v-card class="pa-5" elevation="1">
            ...
            <div
              class="d-flex flex-column justify-center align-content-space-between"
            >
              <!--  Normal login-->
              <v-btn color="light-green darken-1 mb-3" rounded @click="apiLogin"
                >Login
              </v-btn>

              <!--  Google login button -->
              <v-btn class="mb-3" color="white" rounded @click="googleLogin">
                <v-img
                  class="rounded mr-1"
              ...
              <v-row>
                <v-col>
                  ...
                  <router-link :to="{ name: 'Register' }">
                    <v-btn rounded text> Register</v-btn>
                  </router-link>
                </v-col>
                <v-spacer />
                <v-col>
                  ...
                  <router-link :to="{ name: 'ForgotPassword' }">
                    <v-btn rounded text> Forgot password</v-btn>
                  </router-link>
                </v-col>
              </v-row>
            </div>
...
} from "@/Apis/HealthyFormWebApi/AuthApi/AuthApi";
  ...
  methods: {
    ...
    async verifyAccount() {
      try {
        ...
        console.log("Error to send link", e);
      }
    },
  },
};
